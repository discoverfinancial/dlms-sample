...
# DLMS Sample Contribution and Governance Policies

This document describes the contribution process and governance policies of the DLMS Sample project. The project draws influence from, but is not driven by, the [Linux 
...
We welcome any feedback on the quality, stability or performance of DLMS Sample.  If you see incorrect behavior or would like to suggest ways to improve DLMS Sample, please use these guidelines to create an issue in GitHub.
1. Please [check](https://github.com/discoverfinancial/dlms-sample/issues) whether there is already an open issue related to your experience/feedback. If there is, join the discussion and contribute any observations or information that may not already be present in the issue.
2. If there isn't already a relevant issue, create one using one of the provided templates.  Please provide the following information:
    ...
    5. Set `Projects` field to `DLMSSample`
3. If you are reporting a problem that exists in DLMS Sample, try to convey answers for the following:
...
Similar to reporting issues, a user wishing to create a feature request should first [check](https://github.com/discoverfinancial/dlms-sample/issues) whether a similar request has already been made in the system.  Searching for features should include looking for issues with the `enhancement` label.  Additionally, searching on issues with the string `[EPIC]`in the title may prove useful.
...
3. Fork the project repository and prepare your proposed contribution.  All contributions should be created using the latest code from the upstream dev branch.
    ...
    3. In commit messages, reference associated issue.  For example, `commit -m "discoverfinancial/dlms-sample#111: corrected persistence error conditions"`
...
answer our [call for contributions](https://github.com/discoverfinancial/dlms-sample/wiki/Call-for-Contributions), please proceed by:

1. 'forking` the project repository
2. Developing a contribution within your forked repo
3. Opening an [issue or feature enhancement report](https://github.com/discoverfinancial/dlms-sample/issues) where a redirect to the new contribution (forked repo) is captured.
4. Add the GitHub Topic `dlmssample` to your forked repo so that we can query all of GitHub for available features and fixes to import.
...
While DLMS Sample is unable to accept pull requests or code contributions of any kind, we are eager to collaborate with you and share ideas on how you can best use DLMS Sample in your projects and listen to your ideas on how DLMS Sample can be improved.

## Team members

Meet and join our [Team of Contributors](https://github.com/discoverfinancial/dlms-sample/wiki/Maintainers-&-Contributors).
...
* Github Discussions
  ...
  * Link: https://github.com/discoverfinancial/dlms-sample/discussions
* Slack
...
* Blog/Wiki
  * https://github.com/discoverfinancial/dlms-sample/wiki
...
To join our community see the [Onboarding Resources](https://github.com/discoverfinancial/dlms-sample/wiki/Onboarding-Resources) page in the wiki.
...
Our vision for the maturation of this project is outlined in the [Project Roadmap](https://github.com/discoverfinancial/dlms-sample/wiki/Roadmap) which is reflective of our intended milestones/release plan.

### Meetings

Logistics for Project Triage Sessions:
* [Meeting Details](https://github.com/discoverfinancial/dlms-sample/wiki/Communication#meetings)
* [Meeting Minutes](https://github.com/discoverfinancial/dlms-sample/wiki/Meeting-Minutes)
...
Report](https://github.com/discoverfinancial/dlms-sample/issues).

## Documentation
Currently, the bulk of the DLMS Sample documentation lives in the code and in the [README](./README.md).
